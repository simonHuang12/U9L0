...
public class DiscussionBoardRunnerV2 {
    public static void main(String[] args) {
        NewsFeed2 nf = new NewsFeed2();
        ...
        Post mp1 = new MessagePost2(uname, msg);
        nf.addPost(mp1);
        ...
        Post mp2 = new MessagePost2(uname, msg);
        nf.addPost(mp2);
        ...
        Post pp = new PhotoPost2(uname, photoName, caption);
        nf.addPost(pp);
